        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 777.0, 631.0, 150.0, 47.0 ],
                    "text": "sometimes need to move the slider as + 0.5 requires a bang to calc!"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 432.46428149938583, 561.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 575.8928516507149, 621.4285655021667, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 486.6395176053047, 612.4352309703827, 36.0, 22.0 ],
                    "text": "+ 0.5"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 661.3333530426025, 612.4352309703827, 36.0, 22.0 ],
                    "text": "+ 0.5"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 802.0, 512.6162624359131, 150.0, 47.0 ],
                    "text": "range is locked out of actual range if anything looks weird!"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 290.0, 768.4210453033447, 29.5, 22.0 ],
                    "text": "1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 471.0, 668.3937799930573, 246.0, 107.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 441.96428149938583, 612.4352309703827, 31.0, 22.0 ],
                    "text": "sig~"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "" ],
                    "patching_rect": [ 316.3157892227173, 731.5789403915405, 34.0, 22.0 ],
                    "text": "sel 1"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 351.40350818634033, 667.5438532829285, 50.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "parameter_enable": 1,
                    "patching_rect": [ 212.8070182800293, 857.8947286605835, 129.0, 39.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 2,
                    "numoutlets": 0,
                    "patching_rect": [ 212.8070182800293, 925.4385876655579, 44.0, 44.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 257.5438599586487, 803.5087642669678, 57.0, 22.0 ],
                    "text": "sfplay~ 2"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "int", "int" ],
                    "patching_rect": [ 316.3157892227173, 689.4736776351929, 48.0, 22.0 ],
                    "text": "change"
                }
            },
            {
